...
import com.raven.form.frmAccount;
import com.raven.form.frmCustommer;
import com.raven.form.frmOrder;
import com.raven.form.frmProduct;
        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            public void menuSelected(int menuIndex, int subMenuIndex) {
                ...
                if (menuIndex == 0) {
                    ...
                    if (subMenuIndex == 0) {
                        main.showForm(new frmProduct());
                    }
                }else if(menuIndex == 2){
                    main.showForm (new frmAccount());
                }else if(menuIndex == 3){
                    main.showForm (new frmCustommer());
                }else if(menuIndex == 4){
                    main.showForm (new frmOrder());
                }
            }
        });
